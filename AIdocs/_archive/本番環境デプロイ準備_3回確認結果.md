...
- 決済連携（ROBOT PAYMENT）の仕様は別途 AIdocs に整備する
...
6. ✅ デプロイ手順書の存在確認
7. ✅ 管理画面操作手順書の存在確認
8. 決済連携（ROBOT PAYMENT）の仕様・手順は別途 AIdocs に整備する

### ⚠️ 要対応項目

1. ⚠️ **デプロイパッケージの再生成**（最新のコードを反映）
2. （.envテンプレートの旧決済用項目は削除済み）
