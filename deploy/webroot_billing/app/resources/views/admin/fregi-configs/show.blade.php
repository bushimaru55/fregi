...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('admin.fregi-configs.edit') }}" 
        ...
        <div class="p-6 {{ $config->is_active ? 'bg-gradient-to-r from-green-50 to-emerald-50' : 'bg-gray-50' }}">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">ID: {{ $config->id }}</p>
                </div>
                @if($config->is_active)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="text-lg text-gray-800">{{ $config->company_id }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-800">{{ $config->shopid }}</p>
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="text-lg text-gray-800">{{ $config->created_at->format('Y年m月d日 H:i') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-800">{{ $config->updated_at->format('Y年m月d日 H:i') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-800">{{ $config->updated_by ?? '未設定' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 pt-8 border-t">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-700 bg-gray-50 p-3 rounded">{{ $config->notify_url }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-semibold text-gray-500 block mb-1">
                            <i class="fas fa-check-circle text-green-500 mr-2"></i>成功時戻りURL
                        </label>
                        <p class="text-sm text-gray-700 bg-gray-50 p-3 rounded">{{ $config->return_url_success }}</p>
                    </div>
                    <div>
                        <label class="text-sm font-semibold text-gray-500 block mb-1">
                            <i class="fas fa-times-circle text-yellow-500 mr-2"></i>キャンセル時戻りURL
                        </label>
                        <p class="text-sm text-gray-700 bg-gray-50 p-3 rounded">{{ $config->return_url_cancel }}</p>
                    </div>
                </div>
            </div>
        </div>
