...
@section('content')
    ...
    <h1 class="text-3xl font-bold text-gray-800 mb-6">管理者編集</h1>
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">変更する場合のみ入力してください（8文字以上）</p>
                    @error('password')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg theme-input @error('password_confirmation') border-red-500 @enderror">
