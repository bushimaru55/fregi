...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-edit text-indigo-600 mr-3"></i>製品ページのURL編集
        </h2>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        <i class="fas fa-globe text-indigo-500 mr-2"></i>製品ページのURL <span class="text-red-500">*</span>
                    </label>
                    ...
                    <input type="url" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('product_page_url') border-red-500 @enderror"
                           required>
