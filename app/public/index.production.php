 ...
 * 本番環境用 index.php
 * 
 * 配置場所: /var/www/vhosts/dschatbot.ai/httpdocs/webroot/billing/index.php
 * 本体場所: /var/www/vhosts/dschatbot.ai/httpdocs/laravel_billing/
 * 
 * このファイルは本番環境用に絶対パスで設定されています。
 */
